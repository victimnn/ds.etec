        ...
        <div className="relative container mx-auto text-center">
          ...
          >
            <div className="glass p-4 rounded-xl shadow-glow hover-lift">
              <img src="/etec-logo.png" alt="ETEC Logo" className="h-12 sm:h-16 w-auto object-contain logo-white" />
            </div>
            <div className="glass p-4 rounded-xl shadow-glow hover-lift">
              <img src="/cps-logo.png" alt="CPS Logo" className="h-12 sm:h-16 w-auto object-contain logo-white" />
            </div>
            <div className="glass p-4 rounded-xl shadow-glow hover-lift">
              <img src="/sp-logo.png" alt="SP Logo" className="h-12 sm:h-16 w-auto object-contain logo-white" />
            </div>
          </motion.div>
          ...
          >
            <h1 className="text-4xl md:text-6xl font-bold mb-6 tracking-tight">
              ...
              <span className="block text-foreground mt-2 font-extrabold">Desenvolvimento de Sistemas</span>
            </h1>

            <p className="text-lg text-muted-foreground mb-10 max-w-2xl mx-auto leading-relaxed text-pretty">
              No dia 28 de novembro, os alunos apresentam seus Trabalhos de Conclusão de Curso. Uma oportunidade para conhecer projetos inovadores e soluções criativas. Venha prestigiar o futuro da tecnologia!
            </p>

            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button asChild size="lg" className="text-lg px-8 shadow-glow hover-lift group">
                <Link href="/projetos">
                  Ver Projetos <ArrowRight className="ml-2 h-5 w-5 transition-transform group-hover:translate-x-1" />
                </Link>
              </Button>
              <Button variant="outline" size="lg" className="text-lg px-8 glass hover-lift" asChild>
        ...
        <div className="container mx-auto">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Liderança responsável pela gestão e excelência pedagógica do curso.
            </p>
          </motion.div>
                  ...
                  <div className="flex flex-col md:flex-row items-center gap-8">
                    ...
                    <div className="flex-1 text-center md:text-left space-y-4">
                      <div>
                        ...
                        <p className="text-primary font-medium">{coordinator.title}</p>
                      </div>
        ...
        <div className="container mx-auto">
          ...
          >
            ...
            <p className="text-muted-foreground">
              Conheça os docentes que apoiam o desenvolvimento técnico dos projetos.
            </p>
          </motion.div>
          ...
          >
            {advisors.length > 0 ? (
                      ...
                      <CardContent className="p-8">
                        <div className="flex items-center gap-6">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-sm text-primary mb-3 font-medium uppercase tracking-wider">{advisor.expertise}</p>
                            <div className="flex flex-wrap gap-1.5 mb-4">
                              {advisor.achievements?.slice(0, 3).map((ach, i) => (
              ...
              <p className="text-center col-span-2 text-muted-foreground italic">Carregando corpo docente...</p>
            )}
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto">
          ...
          >
            {[
              ...
              { icon: Users, end: totalStudents, label: "Alunos Inscritos", suffix: "+" },
              { icon: Trophy, end: totalTechnologies, label: "Stack Tecnológica", suffix: "+" }
            ].map((stat, i) => (
        ...
        <div className="container mx-auto">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              Explore os trabalhos mais inovadores desenvolvidos pelos nossos estudantes.
            </p>
          </motion.div>
          ...
          >
            <Button asChild size="lg" variant="outline" className="rounded-full px-10 hover:bg-primary hover:text-white transition-all shadow-lg">
              <Link href="/projetos">
