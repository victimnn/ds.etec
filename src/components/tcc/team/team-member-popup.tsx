                ...
                <div className="flex gap-2 justify-center md:justify-end shrink-0">
                  {member.linkedin && (
                    <Button
                      size="icon"
                      variant="outline"
                      className="h-9 w-9 rounded-full hover:text-[#0077b5] hover:border-[#0077b5] hover:bg-[#0077b5]/10 transition-all"
                      asChild
                    >
                      <a
                  ...
                  {member.github && (
                    <Button
                      size="icon"
                      variant="outline"
                      className="h-9 w-9 rounded-full hover:text-foreground hover:border-foreground hover:bg-foreground/10 transition-all"
                      asChild
                    >
                      <a
                        href={member.github}
                  ...
                  {member.instagram && (
                    <Button
                      size="icon"
                      variant="outline"
                      className="h-9 w-9 rounded-full hover:text-[#E1306C] hover:border-[#E1306C] hover:bg-[#E1306C]/10 transition-all"
                      asChild
                    >
                      <a
                  ...
                  {member.portfolio && (
                    <Button
                      size="icon"
                      variant="outline"
                      className="h-9 w-9 rounded-full hover:text-primary hover:border-primary hover:bg-primary/10 transition-all"
                      asChild
                    >
                      <a
                  ...
                  {member.email && (
                    <Button
                      size="icon"
                      variant="outline"
                      className="h-9 w-9 rounded-full hover:text-red-500 hover:border-red-500 hover:bg-red-500/10 transition-all"
                      asChild
                    >
                ...
                <section className="space-y-3">
                  ...
                  <div className="grid gap-3 sm:grid-cols-2">
                    {member.achievements.map((achievement, index) => (
                      <div
                        key={index}
                        className="flex items-start gap-3 p-3 rounded-xl bg-muted/40 border border-border/50 hover:border-primary/20 hover:bg-muted/60 transition-colors"
                      >
                ...
                <div className="flex flex-wrap gap-2">
                  {member.expertise.split(', ').map((skill, index) => (
                    <Badge
                      key={index}
                      variant="secondary"
                      className="px-2.5 py-0.5 text-sm bg-background hover:bg-background/80 border-transparent shadow-sm"
                    >
                      {skill}
                    </Badge>
                  ))}
                  ...
                  <div className="flex flex-wrap gap-2">
                    {member.skills.map((skill, index) => (
                      <Badge
                        key={index}
                        variant="outline"
                        className="px-2.5 py-0.5 text-sm bg-background hover:bg-accent transition-colors"
                      >
                        {skill}
                      </Badge>
                    ))}
