        ...
        <div className="relative container mx-auto px-4 py-24 lg:py-36">
          ...
          >
            ...
            <p className="text-xl text-primary-foreground/90 leading-relaxed max-w-3xl mx-auto text-pretty">
              ...
              DS Etec é o seu primeiro passo para uma carreira de sucesso.
            </p>
        ...
        <div className="container mx-auto">
          <motion.div {...fadeInUp} className="text-center mb-20 space-y-4">
            <h2 className="text-4xl md:text-5xl font-bold tracking-tight">
              Onde Nossos <span className="text-primary">Alunos Estão</span>
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto text-pretty px-4">
              Organizações que confiam e contratam profissionais formados no
                  ...
                  <CardContent className="p-8 flex flex-col items-center justify-center text-center flex-1 space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="space-y-1">
                        ...
                        <Badge
                          variant="secondary"
                          className="text-[9px] uppercase tracking-tighter bg-primary/5 text-primary border-none"
                        >
                          {empresa.setor}
                        </Badge>
                      </div>
        ...
        <div className="container mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div {...fadeInUp} className="space-y-8">
              <h2 className="text-4xl md:text-5xl font-bold tracking-tight">
                Construa um <span className="text-primary">Futuro Sólido</span>
              </h2>
              <p className="text-lg text-muted-foreground leading-relaxed text-pretty">
                Não basta apenas saber codar. No DS Etec, preparamos você para
                as tendências mais recentes do mercado global de tecnologia.
              </p>
              ...
              <div className="space-y-4">
                {[
                  {
                    t: 'Networking Ativo',
                    d: 'Conexão direta com profissionais da área.',
                  },
                  {
                    t: 'Portfólio de Impacto',
                    d: 'Projetos reais para apresentar em entrevistas.',
                  },
                  {
                    t: 'Soft Skills',
                    d: 'Comunicação, liderança e trabalho em equipe.',
                  },
                ].map((item, i) => (
                  <div
                    key={i}
