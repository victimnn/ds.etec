  ...
  const projetos = [
    {
      titulo: 'BusHere! - Web',
      descricao:
        'Aplicação web completa para gestão de transporte escolar para empresas e passageiros',
    ...
    <div className="min-h-screen bg-background bg-grid-slate">
        ...
        <div className="relative container mx-auto px-4 py-24 lg:py-36">
          ...
          >
            ...
            <p className="text-xl text-primary-foreground/90 leading-relaxed max-w-2xl mx-auto text-pretty">
              ...
              durante a jornada acadêmica no DS Etec.
            </p>
          ...
          >
            <div className="space-y-2 text-center md:text-left">
              <h2 className="text-3xl md:text-5xl font-bold tracking-tight">
                Galeria de <span className="text-primary">Inovação</span>
              </h2>
              <p className="text-muted-foreground">
                Filtre por tecnologia e explore o potencial de cada grupo.
              </p>
            </div>
                  ...
                  <Card className="overflow-hidden hover-lift border-border/50 group h-full flex flex-col rounded-[2.5rem] bg-card/50 backdrop-blur-sm shadow-sm hover:shadow-xl transition-all">
                    <div className="relative aspect-video">
                      ...
                      <div className="absolute top-4 right-4 flex flex-col gap-2">
                        <Badge className="bg-primary/90 backdrop-blur-md border-none">
                          {projeto.categoria}
                        </Badge>
                        {projeto.destaque && (
                          <Badge className="bg-yellow-500 text-yellow-950 font-bold border-none">
                      ...
                      <div className="flex gap-3">
                        {projeto.demo && (
                          <Button
                            ...
                            size="sm"
                            variant="outline"
                            className="flex-1 rounded-xl font-bold h-10 border-2 hover:bg-primary hover:text-primary-foreground hover:border-primary transition-all"
                          >
                            <Link href={projeto.demo} target="_blank">
      ...
      <section className="py-24 px-4">
        <div className="container mx-auto">
          <motion.div
            {...fadeInUp}
            className="relative rounded-[3.5rem] bg-muted/50 border border-border/50 p-12 md:p-24 text-center overflow-hidden"
          >
            <div className="absolute inset-0 bg-grid-slate opacity-40" />
            <div className="relative space-y-8 max-w-3xl mx-auto">
              <h2 className="text-4xl md:text-6xl font-black tracking-tighter">
                Seu Projeto no{' '}
                <span className="text-primary text-glow">DS Etec?</span>
              </h2>
              <p className="text-lg md:text-xl text-muted-foreground font-medium leading-relaxed">
                Nossa metodologia foca na criação de portfólios reais que abrem
                portas nas maiores empresas de tecnologia.
              </p>
              <div className="flex justify-center">
                <HeroButtons
                  primaryText="Inscrever-se Agora"
                  secondaryText="Grade Curricular"
                />
              </div>
            </div>
          </motion.div>
