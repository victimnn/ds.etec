...
export function Footer() {
  ...
  const linksRapidos = [
    {
      nome: 'Sobre o Curso',
      href: '/sobre',
      descricao: 'Conheca nossa estrutura',
    },
    {
      nome: 'Projetos',
      href: '/projetos',
    ...
    },
    {
      ...
      href: '/mercado',
      descricao: 'Oportunidades de carreira',
    },
    {
      nome: 'Contato',
      href: '/contato',
  ...
  const informacoes = [
    {
      ...
      valor: institutionContact.serviceHoursText,
      icon: Clock,
    },
    {
      titulo: 'Vagas por Ano',
      valor: '80 alunos (40 por periodo)',
      icon: Users,
    },
  ]
  ...
  const redesSociais = [
    ...
    },
    {
      ...
      icon: Instagram,
      className:
        'bg-gradient-to-r from-pink-500 to-purple-700 hover:from-pink-700 hover:to-purple-800',
    },
  ]
        ...
        <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8">
          <div className="lg:col-span-1 space-y-6">
            ...
            <p className="text-primary-foreground/80 leading-relaxed">
              Formando os profissionais de tecnologia do futuro com ensino de
              qualidade, infraestrutura moderna e metodologia inovadora.
            </p>
