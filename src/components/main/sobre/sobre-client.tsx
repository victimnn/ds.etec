        ...
        <div className="relative container mx-auto px-4 py-24 lg:py-36">
          ...
          >
            ...
            <p className="text-xl text-primary-foreground/90 leading-relaxed max-w-3xl mx-auto text-pretty">
              Descubra por que somos referência na formação de técnicos em
              Desenvolvimento de Sistemas em Amparo e região.
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="space-y-6 text-muted-foreground text-lg leading-relaxed text-pretty text-justify">
                <p>
                  Formar profissionais capazes de atuar com protagonismo na
                  economia digital, unindo teoria acadêmica rigorosa com prática
                  de laboratório constante.
                </p>
                <p>
                  Preparamos nossos alunos para dominar as complexidades do
                  desenvolvimento de software, garantindo uma transição fluida
                  para o mercado de trabalho ou ensino superior.
                </p>
              </div>
        ...
        <div className="container mx-auto">
          <motion.div {...fadeInUp} className="text-center mb-20 space-y-4">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Disciplinas técnicas organizadas por anos letivos.
            </p>
          </motion.div>
      ...
      <section className="py-24 px-4">
        <div className="container mx-auto">
          <motion.div {...fadeInUp} className="text-center mb-20 space-y-4">
            <Badge
              variant="outline"
              className="px-4 py-1 rounded-full border-emerald-500/30 text-emerald-600 bg-emerald-500/5 uppercase text-[10px] font-bold"
            >
              Carreira
            </Badge>
            <h2 className="text-4xl md:text-5xl font-bold tracking-tight">
            ...
            {[
              {
                t: 'Software',
                i: Code,
                d: 'Desenvolvimento de aplicações robustas.',
              },
              {
                t: 'Dados',
                i: Database,
                d: 'Modelagem e administração de dados.',
              },
              {
                t: 'Mobile',
                i: Smartphone,
                d: 'Apps nativos e híbridos para Android/iOS.',
              },
              {
                t: 'Segurança',
                i: Shield,
                d: 'Proteção de dados e sistemas críticos.',
              },
